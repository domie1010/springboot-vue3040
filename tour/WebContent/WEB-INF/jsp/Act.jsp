	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="act/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${act['id'] }">
					<ul class="forminfo">
						<li><label>活动名称<b>*</b></label><input id="name" value="${act['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写公司名称"
							style="width: 518px;" /></li>
						<li><label>活动内容<b>*</b></label><textarea id="content7" name="content">${act['content'] }</textarea></li>
