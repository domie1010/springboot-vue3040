...
<form id="jobform" method="post" action="user/userUpdateF" name="jobform" enctype="multipart/form-data">
...
<tr> 
    ...
    <tr> 
      ...
      <td> 
        <input type="password" name="loginPassword" value="${user['loginPassword'] }"   class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    ...
    <tr> 
      ...
      <td> 
       <input type="text" name="recommendId" value="${user['recommendId'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
