...
<div id="shopcontent">
<form method="post" id="user" action="myAct/informationAddFore" onsubmit="return check();">
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="piczone">
				...
				<td align="center">
				<div id="shopview">
					<img src="upload/upload/${act['url'] }" style="width: 174px;height: 241px;" border="0" id="shoploading" class="shoploading">
				</div>
				</td>
				</tr>
				</table>
          ...
          <td>
		  <div id="prodtitle">${act['name'] } </div>
			<div id="prop">
				发布人姓名：${act['userInfo']['real']['name']}<br />
				发布人年龄：${act['userInfo']['real']['age']}<br />
				<c:if test="${act['userInfo']['real']['sex'] eq 1}">
				发布人性别：男<br />
				</c:if>
				<c:if test="${act['userInfo']['real']['sex'] eq 2}">
				发布人性别：女<br />
				</c:if>
				发布人电话：${act['userInfo']['real']['phone']}<br />
				<input type="hidden" name="user_id" id="user_id" value="${sessionScope['User']['id'] }">
				<input type="hidden" name="act_id" id="act_id" value="${act['id'] }">
				<input type="submit" value="参加" class="submit">
			</div>
			<div style="padding:5px;">
			</div>
			
			<div class="buttonzone"> 
			<!-- <a href="javascript:;" onclick="return bargain();"><img src="image/image/foreground/addusert.gif" alt="订购" width="102" height="27" border="0" class="addtousert"  id="addtousert" ></a>
	...
	<div id="switch_body" class="bodyzone_cap_now">详细信息</div>
