...
<form id="jobform" method="post" action="user/userAddF" name="jobform" enctype="multipart/form-data">
...
<tr> 
    ...
    <tr> 
      ...
      <td> 
        <input type="password" name="loginPassword"  class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    
     <tr> 
      <td width="80" align="right">旅行社名：</td>
      <td> 
	...
	<tr> 
      ...
      <td> 
        <input type="text" name="address" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
    ...
    <tr> 
      <td width="80" align="right">营业编号：</td>
      <td> 
       <input type="text" name="recommendId" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
