...
<tr> 
      ...
      <td> 
        ...
        <input type="text" name="name" value="${act['name'] }" class="input" style="width:200px" />
    ...
    <tr> 
      ...
      <td> 
       <textarea rows="5" cols="80" name="content">${act['content'] }</textarea>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    
     <tr> 
      <td width="80" align="right">上传照片：</td>
      <td> 
       <input type="file" name="file" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
