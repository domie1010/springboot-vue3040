...
<form id="jobform" method="post" action="personal/informationUpdateF" name="jobform" enctype="multipart/form-data">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

	<tr> 
      <td width="80" align="right">兴趣爱好：</td>
      <td> 
       <textarea rows="5" cols="80" name="hobby">${sessionScope['User']['personal']['hobby'] }</textarea>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
     <tr> 
      <td width="80" align="right">向往的地方：</td>
      <td> 
       <textarea rows="5" cols="80" name="like_address">${sessionScope['User']['personal']['like_address'] }</textarea>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    
    <tr> 
      <td width="80" align="right">个人资料：</td>
      <td> 
       <textarea rows="5" cols="80" name="remark">${sessionScope['User']['personal']['remark'] }</textarea>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    ...
    <tr> 
      ...
      <td height="30">
        ...
        <input type="hidden" value="${sessionScope['User']['personal']['id'] }" name="id">
