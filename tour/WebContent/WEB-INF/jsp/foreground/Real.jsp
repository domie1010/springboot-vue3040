...
<form id="jobform" method="post" action="real/informationUpdateF" name="jobform" enctype="multipart/form-data">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >
     ...
     <tr> 
      ...
      <td> 
        <input type="text" name="name" value="${sessionScope['User']['real']['name'] }" class="input" style="width:200px" />
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="age" value="${sessionScope['User']['real']['age'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    ...
    <tr> 
      ...
      <td> 
        <select name="sex">
			<c:if test="${sessionScope['User']['real']['sex'] eq 1}" var="s1">
				<option value="1" selected="selected">男</option>
			</c:if>
			<c:if test="${!s1}">
				<option value="1">男</option>
			</c:if>
			<c:if test="${sessionScope['User']['real']['sex'] eq 2}" var="s2">
	...
	<tr> 
      ...
      <td> 
       <input type="text" name="phone" value="${sessionScope['User']['real']['phone'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    ...
    <tr> 
      ...
      <td> 
       <input type="text" name="card" value="${sessionScope['User']['real']['card'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
    ...
    <tr> 
      ...
      <td height="30">
        ...
        <input type="hidden" value="${sessionScope['User']['real']['id'] }" name="id">
