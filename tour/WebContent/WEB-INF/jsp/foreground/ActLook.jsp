...
<form id="jobform" method="post" action="act/informationUpdateF" name="jobform" enctype="multipart/form-data">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr> 
      <td width="80" align="right">活动名称：</td>
      <td> 
       <c:out value="${act['name'] }" /><div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
    
    <tr> 
      <td width="80" align="right">活动内容：</td>
      <td> 
       <c:out value="${act['content'] }" />
       <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    <c:if test="${act['type'] eq 1}">
	     <tr> 
	      <td width="80" align="right">发布人姓名：</td>
	      <td> 
	       <c:out value="${act['userInfo']['real']['name']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	    </tr>
	    
	     <tr> 
	      <td width="80" align="right">发布人年龄：</td>
	      <td> 
	       <c:out value="${act['userInfo']['real']['age']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	    </tr>
	     <tr> 
	      <td width="80" align="right">发布人性别：</td>
	      <td> 
	    ...
	    <tr> 
	      <td width="80" align="right">发布人电话：</td>
	      <td> 
	       <c:out value="${act['userInfo']['real']['phone']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	    </tr>
    </c:if>
    <c:if test="${act['type'] eq 2}">
    		<tr> 
	      <td width="80" align="right">旅行社名称：</td>
	      <td> 
	       <c:out value="${act['userInfo']['userName']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	    </tr>
	    <tr> 
	      <td width="80" align="right">旅行社电话：</td>
	      <td> 
	       <c:out value="${act['userInfo']['phoneNo']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	    </tr>
	    <tr> 
	      <td width="80" align="right">旅行社电话：</td>
	      <td> 
	       <c:out value="${act['userInfo']['address']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	       <tr> 
	      <td width="80" align="right">旅行社电话：</td>
	      <td> 
	       <c:out value="${act['userInfo']['recommendId']}" />
	       <div style="padding-top:3px;color:#666"></div> </td>
	    </tr>
	    </tr>
    </c:if>
    ...
    <tr> 
      ...
      <td height="30">
        ...
        <input type="hidden" value="id" name="${act['id'] }">
	  </td>
    </tr>
  </table>
</form>
